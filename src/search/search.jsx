    ...
    return (
        <>
            ...
            <Box sx={{
                ...
                pl: 0, }}
            >
                <Box sx = {{background: "linear-gradient(90deg, #2AA7FF, #0C8CE5)", position: "relative", borderBottomLeftRadius: "1rem", borderBottomRightRadius: '1rem' }}>
                     <Container maxWidth = 'xl' sx = {{ background: "#fff", transform: "translatey(50px)", borderRadius: 2, p: 3, mb : "50px" }} >
                        <SearchHospital />
                     </Container>
                </Box>
