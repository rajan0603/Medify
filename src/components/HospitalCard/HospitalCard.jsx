...
//     const [showCalendar, setShowCalendar] = useState(false);
//     return (
//         <Box sx={{background: '#fff', p: {xs : 2, md: 4}, borderRadius: 2 }}>
//             <Stack direction={{xs: 'column', md: 'row'}} flexWrap={'wrap'} spacing={{xs:1, md: 4 }}>
//                 <Box component='img' src = {icon} height='auto' width={{xs:64, md: 130}} />

//                 <Box flex={1}>
//                     <Typography component = 'h3' color= '#14BEF0' fontWeight={600} fontSize={{sx:18, md:20}} lineHeight={1} mb={1} textTransform='capitalize'>
...
//                     </Typography>
//                     <Stack direction='row' flexWrap="wrap" spacing="4px" mb={2} >
//                         <Typography color='primary.green' fontWeight={800} textTransform='uppercase'>FREE</Typography>
...
//                     </Stack>
//                     <Stack>
//                         <Typography textAlign="center" color="primary.green" fontSize={14} fontWeight={500} mb={1}>Available Today</Typography>
