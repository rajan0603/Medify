...
export default function HeroImage(){
    return (
        <Swiper>
            <SwiperSlide>
                <Stack direction={{md: "row", xs: "column"}} spacing={6} alignItems="center" pt={2}>
                    <Box>
                        ...
                        <Typography color="#5C6169" fontSize={{md: 20}} mb={3}>Connect instantly with a 24x7 specialist or choose to video visit a particular doctor.</Typography>
                        <Link to = "/search">
                            <Button variant='contained' size="large" disableElevation>Find Centers</Button>
                        </Link>
                    </Box>
                    <Box component = "img" src = {hero} alt = "hero" width = {{sx: 1, md: "50%" }} />
                </Stack>
            </SwiperSlide>
        </Swiper>
    )
